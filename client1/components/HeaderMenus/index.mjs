...
//  import { customElement, property } from "lit/decorators.js";              // version 2.0 via npm and web dev server
    ...
    import   jMENU   from "./config.json.mjs";  // export default jMENU;      workie: does     provide an export named 'default'
//  import { jMENU } from "./config.json.mjs";  // export default jMENU;   no workie: does not provide an export named 'jMENU'
//  import                "./config.json.mjs";  // export default jMENU;   no workie: jMENU is undefined

//  import   jMENU   from "./config.json.mjs";  // export       { jMENU }; no workie: does not provide an export named 'default'
//  import { jMENU } from "./config.json.mjs";  // export       { jMENU };    workie: does     provide an export named 'jMENU'
//  import                "./config.json.mjs";  // export       { jMENU };    workie: does     provide an export named 'jMENU'

//----------------------------------------------------------------------------------

//  let MenuLitElement = class MenuLitElement extends LitElement {
class HeaderMenus extends LitElement {
...
//----------------------------------------------------------------------------------
    ...
    customElements.define( 'header-menus', HeaderMenus );
