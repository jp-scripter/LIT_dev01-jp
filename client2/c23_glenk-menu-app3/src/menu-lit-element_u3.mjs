...
//  import { customElement, property } from "lit/decorators.js";              // version 2.0 via npm and web dev server
    ...
    import   jMENU   from "./menu-lit-element_v3.json.mjs";  // export default jMENU;      workie: does     provide an export named 'default'
//  import { jMENU } from "./menu-lit-element_v3.json.mjs";  // export default jMENU;   no workie: does not provide an export named 'jMENU'
//  import                "./menu-lit-element_v3.json.mjs";  // export default jMENU;   no workie: jMENU is undefined

//  import   jMENU   from "./menu-lit-element_v3.json.mjs";  // export       { jMENU }; no workie: does not provide an export named 'default'
//  import { jMENU } from "./menu-lit-element_v3.json.mjs";  // export       { jMENU };    workie: does     provide an export named 'jMENU'
//  import                "./menu-lit-element_v3.json.mjs";  // export       { jMENU };    workie: does     provide an export named 'jMENU'
